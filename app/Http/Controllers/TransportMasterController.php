...
class TransportMasterController extends Controller
{
    ...
    {
        return view('transportmaster.index')->with('AJAX_PATH', 'get-transport-detail');
    }
    ...
    public function getData()
    {
         ...
         * indexes */
        $columns = array(
            array('db' => 'transport_name', 'dt' => 0),
            array('db' => 'transport_address', 'dt' => 1),
            array('db' => 'city_name', 'dt' => 2),
            array('db' => 'district', 'dt' => 3),
            array('db' => 'state', 'dt' => 4),
            array('db' => 'mobile', 'dt' => 5),
            array('db' => 'gst_no', 'dt' => 6),
        );
