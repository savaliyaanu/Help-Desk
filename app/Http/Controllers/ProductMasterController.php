...
class ProductMasterController extends Controller
{
    ...
    {
        return view('ProductMaster.index')->with('AJAX_PATH', 'get-product-master-detail');
    }
    ...
    public function getData()
    {
        ...
        $columns = array(
            ...
            array('db' => 'cetsh_hsn', 'dt' => 2),
            array('db' => 'part_code', 'dt' => 3),
            array('db' => 'n_wt', 'dt' => 4),
            array('db' => 'loose_nwt', 'dt' => 5),
            array('db' => 'packed_gwt', 'dt' => 6),
        );
