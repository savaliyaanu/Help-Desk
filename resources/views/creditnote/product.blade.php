@extends('layouts.metronic')@push('styles')
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-8">
                                    ...
                                    <form class="form" id="kt_form"
                                          action="{{($action=='INSERT')? url('credit-note-items'):route('credit-note-items.update',$creditItem->credit_note_item_id) }}"
                                          method="post">
                                    @if ($action=='UPDATE')
                                        {{ method_field('PUT') }}
                                    @endif
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select type="text" id="product_id" name="product_id"
                                                            ...
                                                            @foreach ($challanDetails as $key=>$items)
                                                                <option
                                                                    value="{{$items->challan_product_id}}">{{$items->getProduct->product_name}} ({{$items->serial_no}})
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="amount"
                                                               ...
                                                               value="{{ ((!empty($creditItem->amount)) ?$creditItem->amount :old('amount')) }}"
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        ...
                        <table class="table table-separate table-head-custom table-checkable" id="">
                            ...
                            <tbody>
                            @if(isset($creditItemList))
                                @php $i=1 @endphp
                                @foreach ($creditItemList as $key=>$item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form method="POST" style="display:inline;"
                                                  action="{{ route('credit-note-items.destroy',$item->credit_note_item_id)  }}">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
