            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        <!--begin::Page Title-->
                        <h2 class="subheader-title text-dark font-weight-bold my-2 mr-3">Branch Master</h2>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            ...
                            <form class="form" id="kt_form_1" method="post"
                                  action="{{($action=='INSERT')? url('branch'):route('branch.update',$branch->branch_id)}}"
                                  method="post">
                                @if ($action=='UPDATE')
                                    {{ method_field('PUT') }}
                                @endif
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="input-group">
                                                ...
                                                <?php if(!empty($branch->company_id)){ ?>
                                                <script>document.getElementById("company_id").value = '<?php echo $branch->company_id; ?>';</script>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="input-group">
                                                <input style="width: 100%" class="form-control "
                                                       ...
                                                       value="{{ ((!empty($branch->branch_name)) ?$branch->branch_name :old('branch_name')) }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="input-group">
                                                <input style="width: 100%" id="address1" placeholder="Enter Address"
                                                       ...
                                                       value="{{ ((!empty($branch->address1)) ?$branch->address1 :old('address1')) }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="input-group">
                                                <input style="width: 100%" id="address2" placeholder="Enter Address"
                                                       ...
                                                       value="{{ ((!empty($branch->address2)) ?$branch->address2 :old('address2')) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="input-group">
                                                <input style="width: 100%" id="address3" placeholder="Enter Address"
                                                       ...
                                                       value="{{ ((!empty($branch->address3)) ?$branch->address3 :old('address3')) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-group">
                                                <select type="text" class="form-control kt_select2_5"
                                                        ...
                                                        required title="Please Select City">
                                                ...
                                                <?php if(!empty($branch->city_id)){ ?>
                                                <script>document.getElementById("city_id").value = '<?php echo $branch->city_id; ?>';</script>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <label class="col-form-label text-right col-lg-2 ">District
                                            <span class="text-danger">*</span></label>
                                        <div class="col-lg-4">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="district_id"
                                                       ...
                                                       value="{{ ((!empty($branch->district_id)) ?$branch->district_id :old('district_id')) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-2 ">State <span class="text-danger">*</span></label>
                                        <div class="col-lg-4">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="state_id"
                                                       placeholder="Read State Name" id="state_id" readonly
                                                       value="{{ ((!empty($branch->state_id)) ?$branch->state_id :old('state_id')) }}">
                                            </div>
                                        </div>
                                        <label class="col-form-label text-right col-lg-2 ">PinCode<span class="text-danger">*</span></label>
                                        <div class="col-lg-4">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="pincode"
                                                       placeholder="Enter PinCode" id="pincode"
                                                       value="{{ ((!empty($branch->pincode)) ?$branch->pincode :old('pincode')) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-2 ">GST NO <span class="text-danger">*</span></label>
                                        <div class="col-lg-4">
                                            <div class="input-group date">
                                                <input type="text" class="form-control"
                                                       name="gst_no" placeholder="Enter GST No" id="gst_no"
                                                       value="{{ ((!empty($branch->gst_no)) ?$branch->gst_no :old('gst_no')) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
