            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        <!--begin::Page Title-->
                        <h2 class="subheader-title text-dark font-weight-bold my-2 mr-3">Supplier Pending Product Report</h2>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            ...
                            <form class="form" id="kt_form_1" method="post"
                                  action="{{($action=='INSERT')? route('supplier-pending-report.store'):''}}"
                                  method="post">
                                @if ($action=='UPDATE')
                                    {{ method_field('PUT') }}
                                @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-2 ">Supplier Name
                                        </label>
                                        <div class="col-lg-4 ">
                                            <div class="input-group">
                                                <select style="width: 100%" id="supplier_id" required
                                                        class="form-control kt_select2_5" name="supplier_id">
                                                    <option value="">Select Client Name</option>
                                                    @foreach($supplierDetail as $key=>$items)
                                                        <option
                                                            value="{{$items->supplier_id}}">{{$items->supplier_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
