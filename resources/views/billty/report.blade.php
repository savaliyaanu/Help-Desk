            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        <!--begin::Page Title-->
                        <h2 class="subheader-title text-dark font-weight-bold my-2 mr-3">Billty Pending Statement</h2>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            ...
                            <form class="form" id="kt_form_1" method="post"
                                  action="{{($action=='INSERT')? route('billty-pending-statement.store'):''}}"
                                  method="post">
                                @if ($action=='UPDATE')
                                    {{ method_field('PUT') }}
                                @endif
                                    ...
                                    <div class="row">
                                        <div class="col-4 ml-lg-auto">
                                            <button type="submit" class="btn btn-primary font-weight-bold mr-2" traget="_blank"
                                                    name="submitButton"><i class="flaticon2-printer"></i>Generate Report
                                            </button>
