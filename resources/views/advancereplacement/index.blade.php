    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="subheader py-3 py-lg-8 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                @can('create', App\AdvanceReplacement::class)
                    <div class="d-flex align-items-center">
                        <a href="{{route('advance-replacement.create')}}"
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        <table id="example" class="display" style="width:100%">
                            ...
                            <tbody>
                            @foreach($replacement_out as $row=>$items)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                           title="Replacement Product Inward Pdf" target="_blank"
