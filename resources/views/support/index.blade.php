            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        <!--begin::Page Title-->
                        <h2 class="subheader-title text-dark font-weight-bold my-2 mr-3">Frequently Asked Questions </h2>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Button-->
                    <a href="{{route('support-menu.create')}}"
...
@endsection
@push('scripts')
    <script src="{{asset('metronic/assets/js/pages/features/miscellaneous/sweetalert2.js?v=7.0.4')}}"></script>
