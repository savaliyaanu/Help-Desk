                            ...
                            <div class="card-body p-0 d-flex">
                                <div
                                    ...
                                    <div class="position-absolute right-0 bottom-0 mr-5 overflow-hidden">
                                        <img src="{{ asset('metronic/assets/media/svg/humans/custom-13.svg') }}"
                            ...
                            <div class="card-header h-auto border-0">
                                ...
                                <div class="card-title py-5">
                                    <h3 class="card-label">
                                        ...
                                        <span
                                            class="d-block text-dark-50 mt-2 font-size-sm">More than 500+ new orders</span>
                                    </h3>
                                </div>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                        ...
                        <div class="card card-custom bg-light-success gutter-b card-stretch card-shadowless">
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-white mr-5">
                                        <div class="symbol-label">
                                            <img src="{{ asset('metronic/assets/media/svg/avatars/004-boy-1.svg')}}"
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-white mr-5">
                                        <div class="symbol-label">
                                            <img src="{{ asset('metronic/assets/media/svg/avatars/002-girl.svg')}}"
                                                 class="h-75 align-self-end" alt=""/>
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-white mr-5">
                                        <div class="symbol-label">
                                            <img src="{{ asset('metronic/assets/media/svg/avatars/007-boy-2.svg')}}"
                                                 class="h-75 align-self-end" alt=""/>
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-white mr-5">
                                        <div class="symbol-label">
                                            <img src="{{ asset('metronic/assets/media/svg/avatars/008-boy-3.svg')}}"
                                                 class="h-75 align-self-end" alt=""/>
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                            ...
                                            <td class="pl-0 py-4">
                                                <div class="symbol symbol-50 symbol-light mr-1">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/misc/006-plurk.svg')}}"
                                        ...
                                        <tr>
                                            <td class="pl-0 py-4">
                                                <div class="symbol symbol-50 symbol-light">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/misc/015-telegram.svg') }}"
                                                                                class="h-50 align-self-center" alt=""/>
																		</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="pl-0 py-4">
                                                <div class="symbol symbol-50 symbol-light">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/misc/003-puzzle.svg')}}"
                                                                                class="h-50 align-self-center" alt=""/>
																		</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="pl-0 py-4">
                                                <div class="symbol symbol-50 symbol-light">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/misc/005-bebo.svg')}}"
                                                                                class="h-50 align-self-center" alt=""/>
																		</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="pl-0 py-4">
                                                <div class="symbol symbol-50 symbol-light">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/misc/014-kickstarter.svg')}}"
                                                                                class="h-50 align-self-center" alt=""/>
																		</span>
                                                </div>
                                            </td>
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-success mr-5">
														<span class="symbol-label">
															<img
                                                                src="{{ asset('metronic/assets/media/svg/avatars/009-boy-4.svg')}}"
                                                                class="h-75 align-self-end" alt=""/>
														</span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-success mr-5">
														<span class="symbol-label">
															<img
                                                                src="{{ asset('metronic/assets/media/svg/avatars/006-girl-3.svg')}}"
                                                                class="h-75 align-self-end" alt=""/>
														</span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-success mr-5">
														<span class="symbol-label">
															<img
                                                                src="{{ asset('metronic/assets/media/svg/avatars/011-boy-5.svg')}}"
                                                                class="h-75 align-self-end" alt=""/>
														</span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-success mr-5">
														<span class="symbol-label">
															<img
                                                                src="{{ asset('metronic/assets/media/svg/avatars/015-boy-6.svg')}}"
                                                                class="h-75 align-self-end" alt=""/>
														</span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-success mr-5">
														<span class="symbol-label">
															<img
                                                                src="{{ asset('metronic/assets/media/svg/avatars/016-boy-7.svg')}}"
                                                                class="h-75 align-self-end" alt=""/>
														</span>
                                    </div>
                                    <!--end::Symbol-->
                                            ...
                                            <td class="pl-0">
                                                <a href="#"
                                                   class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Top
                                                    Authors</a>
                                                <span
                                                    class="text-muted font-weight-bold d-block">Successful Fellas</span>
                                            </td>
                                            <td class="text-right">
                                            ...
                                            <td class="pl-0">
                                                <a href="#"
                                                   class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Bestseller
                                                    Theme</a>
                                                <span
                                                    class="text-muted font-weight-bold d-block">Amazing Templates</span>
                                            </td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/avatars/001-boy.svg')}}"
                                                                                class="h-75 align-self-end" alt=""/>
																		</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/avatars/018-girl-9.svg')}}"
                                                                                class="h-75 align-self-end" alt=""/>
																		</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-lightv mt-1">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/avatars/047-girl-25.svg')}}"
                                                                                class="h-75 align-self-end" alt=""/>
																		</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img
                                                                                src="{{ asset('metronic/assets/media/svg/avatars/014-girl-7.svg')}}"
                                                                                class="h-75 align-self-end" alt=""/>
																		</span>
                                                </div>
                                            </td>
