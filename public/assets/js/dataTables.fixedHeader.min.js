...
$jscomp.findInternal = function (b, h, g) {
    ...
    for (var l = b.length, k = 0; k < l; k++) {
        var w = b[k];
        if (h.call(g, w, k, b)) return {i: k, v: w}
    }
    return {i: -1, v: void 0}
};
$jscomp.ASSUME_ES5 = !1;
...
(function (b) {
    ...
    b.extend(t.prototype, {
        ...
        footerOffset: function (a) {
            ...
            var c =
                this, f = this.s.dt, e = this.dom[a], p = "header" === a ? this.dom.thead : this.dom.tfoot;
            if ("footer" !== a || !this._scrollEnabled()) if (!d && e.floating) e.floating.removeClass("fixedHeader-floating fixedHeader-locked"); else {
                e.floating && (null !== e.placeholder && e.placeholder.remove(), this._unsize(a), e.floating.children().detach(), e.floating.remove());
                var q = b(f.table().node()), n = b(q.parent()), r = this._scrollEnabled();
                d = b(g).scrollLeft();
                var m = b(g).scrollTop();
                ...
                }).css("header" === a ? {top: this.c.headerOffset, bottom: ""} : {
                    top: "",
            ...
            if (this._scrollEnabled()) {
                var c = this, f = "rtl" === b(c.s.dt.table().node()).css("direction");
            ...
            var c = function (p) {
                ...
                b(p, d).each(function (n) {
                    b(this).css({width: q[n], minWidth: q[n]})
                })
            }, e = c("th");
            c = c("td");
            f("th", e);
            ...
            var c = this.dom[a], f = this.s.scrollLeft;
            if (c.floating && f[a] !== d) {
                if (this._scrollEnabled()) {
            ...
            var f = this.dom[d],
                e = this.s.position, p = this._scrollEnabled();
            if ("footer" !== d || !p) {
                var q = function (B) {
            ...
            var a = this.s.dt, d = a.table(), c = this.s.position, f = this.dom;
            d = b(d.node());
            var e = this._scrollEnabled(), p = b(a.table().header());
            a = b(a.table().footer());
            f = f.tbody;
            var q = d.parent();
            ...
            if (!this.s.dt.settings()[0].bDestroying) {
                var d = this._scrollEnabled(), c = b(this.s.dt.table().node()).parent(), f = c.offset(),
                    e = c.outerHeight(), p =
                        b(g).scrollLeft(), q = b(g).scrollTop(), n = b(h).height(), r = n + q, m = this.s.position,
                    u = d ? f.top : m.tbodyTop, z = d ? f.left : m.left;
                ...
                var x = {offset: {top: 0, left: 0}, height: 0}, y = {offset: {top: 0, left: 0}, height: 0};
